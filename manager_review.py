...
# Form implementation generated from reading ui file 'manager_review.ui'
#
...
class Ui_managerForm(object):
    def setupUi(self, managerForm):
        ...
        managerForm.setStyleSheet("QDialog{\n"
...
"    qproperty-icon: url(:/meduit/arrow-left.png);\n"
"}\n"
"\n"
"QCalendarWidget QWidget#qt_calendar_nextmonth{\n"
"    qproperty-icon: url(:/meduit/arrow-right.png);\n"
"}\n"
...
"}")
        ...
        self.agentName.setMinimumSize(QtCore.QSize(50, 0))
        ...
        self.lineEdit_2 = QtWidgets.QLineEdit(self.agentDetails)
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.gridLayout.addWidget(self.lineEdit_2, 3, 1, 1, 2)
        self.lineEdit = QtWidgets.QLineEdit(self.agentDetails)
        self.lineEdit.setObjectName("lineEdit")
        self.gridLayout.addWidget(self.lineEdit, 1, 4, 1, 2)
        self.dateEdit = QtWidgets.QDateEdit(self.agentDetails)
        self.dateEdit.setAlignment(QtCore.Qt.AlignCenter)
        self.dateEdit.setCalendarPopup(True)
        self.dateEdit.setObjectName("dateEdit")
        self.gridLayout.addWidget(self.dateEdit, 3, 4, 1, 2)
        ...
        self.lineEdit_3 = QtWidgets.QLineEdit(self.agentDetails)
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.gridLayout.addWidget(self.lineEdit_3, 5, 1, 1, 5)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.plainTextEdit, 1, 1, 1, 1)
        self.gridLayout_2.addWidget(self.groupBox_3, 2, 1, 1, 2)

        self.retranslateUi(managerForm)
        self.closeButton.clicked.connect(managerForm.close)
    ...
    def retranslateUi(self, managerForm):
        ...
        managerForm.setWindowTitle(_translate("managerForm", "Manager Review Template"))
        self.managerCombo.setItemText(0, _translate("managerForm", "All"))
        self.radioButton_4.setText(_translate("managerForm", "Disciplinary"))
        self.radioButton.setText(_translate("managerForm", "One on One"))
        self.radioButton_3.setText(_translate("managerForm", "Coaching"))
        self.radioButton_2.setText(_translate("managerForm", "Side by Side"))
        self.label_20.setText(_translate("managerForm", "Employee Select:"))
        self.label_21.setText(_translate("managerForm", "Manager Filter:"))
        self.editButton.setText(_translate("managerForm", "Edit"))
        ...
        self.label_4.setText(_translate("managerForm", "Issued Via:"))
        ...
        self.label_9.setText(_translate("managerForm", "One on One Review"))
